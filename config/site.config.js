...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'xasukax@tangbai.cc',
  ...
  email: 'mailto:asuka_02@foxmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Asuka-pixel2',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/Ming_Ri_Xiang',
    },
  ],
